...
CREATE INDEX idx_gift_002 ON public.gift USING btree (community_gift_id);
CREATE INDEX idx_user_buy_game_001 ON public.user_buy_game USING btree (purchase_date);
CREATE INDEX idx_user_buy_game_002 ON public.user_buy_game USING btree (user_id);
CREATE INDEX idx_game_event_001 ON public.game_event USING btree (game_id);
