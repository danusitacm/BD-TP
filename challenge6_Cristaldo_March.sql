...
CREATE INDEX idx_comunnity_user_001 ON public.comunnity_user USING btree (community_id);
CREATE INDEX idx_comunnity_user_002 ON public.comunnity_user USING btree (user_community_id);
CREATE INDEX idx_user_buy_game_001 ON public.user_buy_game USING btree (game_id);
CREATE INDEX idx_user_buy_game_002 ON public.user_buy_game USING btree (user_id);
CREATE INDEX idx_gift_001 ON public.gift USING btree (user_id);
CREATE INDEX idx_gift_002 ON public.gift USING btree (game_gift_id);
CREATE INDEX idx_gift_003 ON public.gift USING btree (community_gift_id);
CREATE INDEX idx_game_event_001 ON public.game_event USING btree (event_id);
CREATE INDEX idx_game_event_002 ON public.game_event USING btree (game_id);
CREATE INDEX idx_game_review_001 ON public.game_review USING btree (user_id);
CREATE INDEX idx_game_review_002 ON public.game_review USING btree (game_id);
